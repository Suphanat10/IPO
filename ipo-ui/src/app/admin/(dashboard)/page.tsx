      ...
      <Grid container spacing={2} sx={{ alignItems: "stretch" }}>
        <Grid size={{ xs: 12, lg: 6 }} sx={{ display: "flex" }}>
          <AdminPanel
            ...
            action={
              <Link href="/admin/builds" style={{ textDecoration: "none", color: adminColors.accent, fontSize: 13, fontWeight: 800 }}>
                ดูทั้งหมด / View all
              </Link>
            }
            noPadding
        ...
        <Grid size={{ xs: 12, lg: 6 }} sx={{ display: "flex" }}>
          <AdminPanel
            ...
            action={
              <Link href="/admin/upcoming" style={{ textDecoration: "none", color: adminColors.accent, fontSize: 13, fontWeight: 800 }}>
                ดูทั้งหมด / View all
              </Link>
            }
            noPadding
