-- =====================================================
-- Expand completeness tracking from 10 → 18 required fields
-- Matches the full field list defined in the admin data-quality spec.
-- company_name is excluded (not editable in the form).
--
-- New fields added to completeness check:
--   ipos:           market, sector
--   ipo_financials: gross_proceeds, total_expense, offered_shares,
--                   total_assets, total_liabilities, revenue_latest
-- =====================================================
...
-- 2. Rebuild v_ipo_completeness — 18 required fields
...
-- 5. Rebuild v_ipo_missing_fields — 18 fields
